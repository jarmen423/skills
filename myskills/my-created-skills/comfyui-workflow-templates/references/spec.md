...
| `username` | string | ❌ | Creator username (maps to `creators.json`) |
...
This validates:
- All index*.json files (11 total: `index.json` + 10 locale variants)
...
## Template Categories in bundles.json

Four bundle categories:
- **media-api**: Third-party API integrations (DALL-E, Sora, RunwayGen, ElevenLabs, etc.)
- **media-image**: Local image models and templates (200+ items)
- **media-video**: Video generation models (50+ items)
- **media-other**: Audio, 3D, utilities (80+ items)
